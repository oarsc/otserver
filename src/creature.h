...
#define EVENT_CREATURE_COUNT 5
#define EVENT_CREATURE_THINK_INTERVAL 250
#define EVENT_CHECK_CREATURE_INTERVAL (EVENT_CREATURE_THINK_INTERVAL / EVENT_CREATURE_COUNT)
...
public:
	...
	virtual bool onAttacking(uint32_t interval);
	virtual void onWalk();
...
protected:
	...
	virtual bool doAttacking(uint32_t interval) { return false; };
